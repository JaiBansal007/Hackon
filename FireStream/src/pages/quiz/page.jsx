      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8 bg-gradient-to-r from-gray-900/70 to-black/70 backdrop-blur-lg rounded-2xl p-6 border border-orange-500/30 shadow-lg shadow-orange-500/20">
            ...
            <div className="text-center">
              <h1 className="text-3xl pb-3 font-bold bg-gradient-to-r from-orange-400 via-yellow-400 to-amber-400 bg-clip-text text-transparent">
                {quiz.movieTitle}
              </h1>
                  ...
                  <motion.button
                    ...
                    className={`group p-6 rounded-xl text-left transition-all duration-300 border-2 ${
                      selectedAnswers[currentQuestion] === index
                        ? "bg-gradient-to-r from-orange-700/20 via-yellow-700/20 to-amber-700/20 border-orange-600 shadow-lg shadow-orange-600/30"

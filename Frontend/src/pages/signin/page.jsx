  ...
  return (
    <>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          {/* Top row videos */}
          <div className="absolute top-8 left-8 w-72 h-40 rounded-xl shadow-2xl opacity-60 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-red-600 via-orange-500 to-yellow-500 rounded-xl flex items-center justify-center">
          ...
          <div className="absolute top-8 right-8 w-64 h-36 rounded-xl shadow-2xl opacity-50 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-blue-600 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center">
          ...
          {/* Middle row videos */}
          <div className="absolute top-1/2 left-4 w-80 h-44 rounded-xl shadow-2xl opacity-45 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-emerald-600 via-teal-500 to-cyan-500 rounded-xl flex items-center justify-center">
                <Play className="w-12 h-12 text-white/80" />
              </div>
            </video>
            <div className="absolute inset-0 bg-black/30 rounded-xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="absolute top-1/2 right-4 w-68 h-38 rounded-xl shadow-2xl opacity-40 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-violet-600 via-purple-500 to-fuchsia-500 rounded-xl flex items-center justify-center">
                <Play className="w-10 h-10 text-white/80" />
              </div>
            </video>
            <div className="absolute inset-0 bg-black/30 rounded-xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
          ...
          {/* Bottom row videos */}
          <div className="absolute bottom-8 left-12 w-76 h-42 rounded-xl shadow-2xl opacity-50 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-orange-600 via-red-500 to-pink-500 rounded-xl flex items-center justify-center">
                <Play className="w-11 h-11 text-white/80" />
              </div>
            </video>
            <div className="absolute inset-0 bg-black/30 rounded-xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="absolute bottom-8 right-12 w-60 h-34 rounded-xl shadow-2xl opacity-45 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-500 rounded-xl flex items-center justify-center">
          ...
          {/* Additional smaller video previews */}
          <div className="absolute top-1/4 left-1/4 w-48 h-28 rounded-lg shadow-xl opacity-35 overflow-hidden">
            <video 
              autoPlay 
              muted 
              loop 
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-yellow-600 via-orange-500 to-red-500 rounded-lg flex items-center justify-center">
          ...
          <div className="absolute top-3/4 right-1/4 w-52 h-30 rounded-lg shadow-xl opacity-40 overflow-hidden">
            <video 
              ...
              loop 
              className="w-full h-full object-cover rounded-lg"
              style={{filter: 'brightness(0.3) contrast(1.7)'}}
            >
              <source src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4" type="video/mp4" />
              <div className="w-full h-full bg-gradient-to-br from-teal-600 via-green-500 to-emerald-500 rounded-lg flex items-center justify-center">
                <Play className="w-8 h-8 text-white/70" />
              </div>
            </video>
            <div className="absolute inset-0 bg-black/40 rounded-lg flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
